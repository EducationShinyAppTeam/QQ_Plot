  ...
  },
  {
    ...
    output$plotleft1 <- renderPlot({
      curve(dgamma(-x, shape = input$leftskew, beta = 1),
        main = "Population Graph", col = "black", xlab = "value", 
        ylab = "density",lwd = 5, cex.lab = 1.5, cex.axis = 1.5, 
    ...
    output$plotsymmetric1 <- renderPlot({
      ...
      if (input$inverse == 1) {
        plot(x, dens, type = "l", yaxs = "i", xaxs = "i", xlim = c(-0.03,1.03),
             ...
             col = "black", lwd = 5)
        segments(0,0,0,1, col = "black",lwd = 5)
        segments(1,0,1,1, col = "black",lwd = 5)
    ...
    output$plotbiomodel1 <- renderPlot({
      ...
      plot(y, Z, type = "l", yaxs = "i", xaxs = "i",
           ...
           cex.lab = 1.5, cex.axis = 1.5, cex.main = 1.5, cex.sub = 1.5,
           col = "black", lwd = 5)
      lines(y, Z, type = "l", col = "black", xlab = "",ylab = "")
    })
